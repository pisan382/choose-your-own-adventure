...
export default function NodeEditor({ node, nodeId, allNodeIds, onSave, onDelete, onClose, isStart }) {
    ...
    <div style={s.panel}>
      ...
      <div style={s.body}>
        ...
        <div>
          ...
          <input style={s.input} value={title} onChange={e => setTitle(e.target.value)} placeholder="Page title" />
        </div>

        {/* ID */}
        <div>
          <label style={s.label}>Node ID</label>
          <input style={{ ...s.input, opacity: 0.6 }} value={nodeId} readOnly />
        </div>
