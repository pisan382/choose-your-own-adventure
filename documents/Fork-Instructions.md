...
There are many other challenges. I started the project and recorded my AI instructions in documents/AI-Instructions.md. The chat logs with AI are in AI-session-log-20260408950.json and similarly named files. Keep up the practice to create a history of how the project develops.
